...
VALUES(101, "andre@gmail.com", 1);

INSERT INTO PEDIDO (ID_PEDIDO, LOGIN_USUARIO, STATUS)
VALUES(102,"andre@gmail.com", 1);

INSERT INTO PEDIDO (ID_PEDIDO, LOGIN_USUARIO, STATUS)
VALUES(103,"ana@outlook.com", 1);

INSERT INTO PEDIDO (ID_PEDIDO, LOGIN_USUARIO, STATUS)
VALUES(104, "andre@gmail.com", 1);

INSERT INTO PEDIDO (ID_PEDIDO, LOGIN_USUARIO, STATUS)
VALUES(105, "ana@outlook.com", 1);
...
INSERT INTO PAGAMENTO (CODIGO, ENDERECO, ID_PEDIDO, TIPO, TOTAL)
VALUES (10001, "Savassi", 101, 0, 2780.99);

INSERT INTO PAGAMENTO (CODIGO, ENDERECO, ID_PEDIDO, TIPO, TOTAL)
VALUES (10002, "Prado", 102, 0, 7899.00);

INSERT INTO PAGAMENTO (CODIGO, ENDERECO, ID_PEDIDO, TIPO, TOTAL)
VALUES (10003, "Nova Gamileira", 103, 0, 599.80);

INSERT INTO PAGAMENTO (CODIGO, ENDERECO, ID_PEDIDO, TIPO, TOTAL)
VALUES (10004, "Pampulha", 104, 0, 4999.00);

INSERT INTO PAGAMENTO (CODIGO, ENDERECO, ID_PEDIDO, TIPO, TOTAL)
VALUES (10005, "Centro", 105, 0, 799.78);